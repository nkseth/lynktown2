...
const SellingSteps = () => {
  ...
  return (
    <div className='wrapper relative h-[2800px]'>
      <div className='selling-steps container  mx-auto h-full   '>
        <div className='grid grid-cols-2 h-screen item-container items-center justify-center  justify-items-center  '>
          <div>
          ...
          <div className='justify-self-start'>
            ...
            <div className='relative flex flex-col gap-4 h-full mt-4'>
              ...
              <div className='flex gap-5 step_1'>
                ...
                <div>
                  <h1 className='text-2xl opacity-80'>Add product details</h1>
              ...
              <div className='flex gap-5 step_3'>
                ...
                <div className='h-[20px] step_text--3'>
                  <h1 className='text-2xl opacity-80'>Share on social media</h1>
                  <p className='my-2 text-[#757575] opacity-0'>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                    do eiusmod tempor incididunt ut labore
                  </p>
