...
import MeasurementImg from '/public/assets/images/features/payment.png';

const Payment = ({ currentTab }) => {
  return (
    <AnimatePresence>
      {currentTab === 'payment' && (
        <motion.div
        ...
        >
          <div className='order-2 lg:order-[-1]'>
            ...
            >
              Choose a payment type you like
            </motion.h1>
            <motion.p
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              Choose payment methods that best suits you and your business.
            </motion.p>
