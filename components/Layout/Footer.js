  ...
  return (
    <footer className='bg-primaryColor px-4 pt-16'>
      <div className='container mx-auto'>
        <div className='grid lg:grid-cols-[75%_25%] gap-4 sm:gap-11 items-center'>
        ...
        <div className='md:text-base mt-6  justify-center flex sm:hidden text-white text-[8px]  text-center mx-auto gap-2 items-center'>
